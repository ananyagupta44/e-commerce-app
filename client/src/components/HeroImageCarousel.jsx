...
const slideStyles = [
  ...
  "translate-x-[140px] translate-y-[20px] scale-[0.82] opacity-50 z-40 rounded-[32px]",
  "translate-x-[220px] translate-y-[40px] scale-[0.65] opacity-20 z-30",
  "-translate-x-[220px] translate-y-[40px] scale-[0.65] opacity-20 z-30",
  "-translate-x-[140px] translate-y-[20px] scale-[0.82] opacity-50 z-40",
];
    ...
    <div className="relative flex-1 min-w-[400px] h-[700px] flex items-center justify-center overflow-visible">
      ...
      <div className="relative w-[420px] h-[600px] flex items-center justify-center">
        {images.map((img, index) => {
          ...
          const styles = slideStyles[position] ?? "opacity-0";

          return (
            <div key={img} className={`${imageCardClasses} ${styles}`}>
              <img
                src={img}
